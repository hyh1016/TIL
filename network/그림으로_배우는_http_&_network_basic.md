# 그림으로\_배우는\_http\_&\_network\_basic

## 도서명

#### 우에노 센. 2015. [그림으로 배우는 HTTP & Network Basic](https://book.naver.com/bookdb/book\_detail.nhn?bid=8657832)

## 목차

* [1장. HTTP의 탄생과 성장](그림으로\_배우는\_http\_&\_network\_basic.md#-1장-http의-탄생과-성장)
* [2장. HTTP Protocol의 구조](그림으로\_배우는\_http\_&\_network\_basic.md#-2장-http-protocol의-구조)
* [3장. 다양한 요청응답 동작](그림으로\_배우는\_http\_&\_network\_basic.md#-3장-다양한-요청응답-동작)
* [4장. HTTP 상태 코드](그림으로\_배우는\_http\_&\_network\_basic.md#-4장-http-상태-코드)
* [5장. HTTP와 연계하는 웹 서버](그림으로\_배우는\_http\_&\_network\_basic.md#-5장-http와-연계하는-웹-서버)
* [6장. HTTP 헤더](그림으로\_배우는\_http\_&\_network\_basic.md#-6장-http-헤더)
* [7장. 웹을 안전하게 지켜주는 HTTPS](그림으로\_배우는\_http\_&\_network\_basic.md#-7장-웹을-안전하게-지켜주는-https)
* [8장. 누가 액세스하고 있는가? (인증)](그림으로\_배우는\_http\_&\_network\_basic.md#-8장-누가-액세스하고-있는가-인증)
* [9장. HTTP에 기능을 추가한 프로토콜](그림으로\_배우는\_http\_&\_network\_basic.md#-9장-http에-기능을-추가한-프로토콜)

## ✔ 1장. HTTP의 탄생과 성장

### [WWW (World Wide Web)](https://ko.wikipedia.org/wiki/%EC%9B%94%EB%93%9C\_%EC%99%80%EC%9D%B4%EB%93%9C\_%EC%9B%B9) 의 탄생
...
![image](https://user-images.githubusercontent.com/59721541/147845881-f306573c-a052-424f-92f2-63b914a0037c.png) HTTP/1.1 에서는 가상 호스트 라는 기능을 통해 하나의 HTTP 서버에 여러 웹 사이트를 올릴 수 있다.
